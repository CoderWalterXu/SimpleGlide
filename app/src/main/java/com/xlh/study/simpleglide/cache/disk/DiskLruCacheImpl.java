package com.xlh.study.simpleglide.cache.disk;
...
import com.xlh.study.simpleglide.pool.BitmapPool;
    ...
    public Value get(String key, BitmapPool bitmapPool) {
        ...
        try {
            ...
            if (null != snapshot) {
                ...
                Bitmap bitmapPoolResult = bitmapPool.getBitmap(w, h, Bitmap.Config.RGB_565);
